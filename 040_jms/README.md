...
*Predpogoji: na strežniku je potrebno aktivirati dodatek JMS (v WildFly 10.1 je to ActiveMQ), dodati sporoèilne vrste in teme ter dodati aplikacijskega uporabnika.*