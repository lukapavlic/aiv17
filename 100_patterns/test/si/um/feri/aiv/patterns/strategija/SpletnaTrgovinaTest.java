...
public class SpletnaTrgovinaTest {
	...
	public void testVisa() {
		...
		Assert.assertEquals(st.placajNakup(), "Plaèujem z Viso");
	}
	
	@Test
	public void testPaypal() {
		SpletnaTrgovina st=new SpletnaTrgovina(new PayPal());
		Assert.assertEquals(st.placajNakup(), "Plaèujem s PayPal-om");
	}
	
	@Test
	public void testMastercard() {
		SpletnaTrgovina st=new SpletnaTrgovina(new Mastercard());
		Assert.assertEquals(st.placajNakup(), "Plaèujem z Masercardom");
	}
